...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#111" :foreground "#79c"))))
 '(mouse ((t (:foregound "SteelBlue"))))
 '(cursor ((t (:foregound "SteelBlue"))))
 '(border ((t (:foregound "#111"))))

 '(bg:erc-color-face0 ((t (:background "White"))))
 '(bg:erc-color-face1 ((t (:background "#111"))))
 ...
 '(erc-inverse-face ((t (:background "#111" :foreground "White"))))
 ...
 '(erc-prompt-face ((t (:bold t :background "lightBlue2" :foreground "#111" :weight bold))))
 '(erc-timestamp-face ((t (:bold t :foreground "green" :weight bold))))
 '(erc-underline-face ((t (:underline t))))
 '(fg:erc-color-face0 ((t (:foreground "White"))))
 '(fg:erc-color-face1 ((t (:foreground "#111"))))
 ...
 '(gnus-summary-cancelled-face ((t (:background "#111" :foreground "yellow"))))
 ...
 '(tool-bar ((t (:background "grey75" :foreground "#111" :box (:line-width 1 :style released-button)))))
 '(tooltip ((t (:background "lightyellow" :foreground "#111"))))
