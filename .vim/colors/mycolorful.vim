...
let g:colors_name = "colorful256"
 ...
 highlight Normal       cterm=none    ctermfg=249 ctermbg=233  gui=none    guifg=#b2b2b2 guibg=#000000
 highlight Special      cterm=none    ctermfg=105 ctermbg=233  gui=none    guifg=#8787ff guibg=#000000
 highlight Comment      cterm=none    ctermfg=3   ctermbg=233  gui=none    guifg=#808000 guibg=#000000
 highlight Constant     cterm=none    ctermfg=9   ctermbg=233  gui=none    guifg=#ff0000 guibg=#000000
 highlight LineNr       cterm=none    ctermfg=48  ctermbg=233  gui=none    guifg=#00ff87 guibg=#000000
 highlight Number       cterm=none    ctermfg=209 ctermbg=233  gui=none    guifg=#ff875f guibg=#000000
 highlight PreProc      cterm=none    ctermfg=10  ctermbg=233  gui=none    guifg=#ff00ff guibg=#000000
 highlight Statement    cterm=none    ctermfg=51  ctermbg=233  gui=none    guifg=#00ffff guibg=#000000
 highlight Type         cterm=none    ctermfg=39  ctermbg=233  gui=none    guifg=#00afff guibg=#000000
 highlight Error        cterm=none    ctermfg=9   ctermbg=233  gui=none    guifg=#ff0000 guibg=#000000
 highlight Identifier   cterm=none    ctermfg=207 ctermbg=233  gui=none    guifg=#ff5fff guibg=#000000
 highlight SpecialKey   cterm=none    ctermfg=236  ctermbg=233  gui=none    guifg=#00af87 guibg=#000000
 highlight NonText      cterm=none    ctermfg=236 ctermbg=233  gui=none    guifg=#df00df guibg=#000000
 highlight Directory    cterm=none    ctermfg=34  ctermbg=233  gui=none    guifg=#00af00 guibg=#000000
 highlight ErrorMsg     cterm=none    ctermfg=9   ctermbg=233  gui=none    guifg=#ff0000 guibg=#000000
 highlight MoreMsg      cterm=none    ctermfg=34  ctermbg=233  gui=none    guifg=#00af00 guibg=#000000
 highlight Title        cterm=none    ctermfg=199 ctermbg=233  gui=none    guifg=#ff00af guibg=#000000
 highlight WarningMsg   cterm=none    ctermfg=9   ctermbg=233  gui=none    guifg=#ff0000 guibg=#000000
 highlight DiffDelete   cterm=none    ctermfg=207 ctermbg=233  gui=none    guifg=#ff5fff guibg=#000000
